...
/**
 * Represents a "Loop" control in the workflow system.
 * This class extends the base Control class and is
 * distinguished by the discriminator value "loop".
 * It is used to represent a step in the workflow where
 * a set of actions should be repeated a specified number
 * of times.
 */
@Entity
@Getter
...
public class Loop extends Control {
	 ...
	 * This field specifies how many times the loop should execute.
	 */
